...
const TestResultSchema = new Schema<ITestResult>(
  {
    ...
    loaiXetNghiem: {
      type: String,
      enum: ['cell', 'thinprep', 'hpv40', 'hpv20', 'hpv23', 'soituoi', 'giaiphaubenh', 'combo_hpv20_cell', 'combo_hpv40_cell', 'combo_hpv23_cell', 'combo_hpv20_thinprep', 'combo_hpv40_thinprep', 'combo_hpv23_thinprep'],
      default: 'cell',
    },
...
export async function generateMaSo(loaiXetNghiem = 'cell'): Promise<string> {
  ...
  else if (loaiXetNghiem === 'combo_hpv23_cell') prefix = 'GTHD-CB23C';
  ...
  else if (loaiXetNghiem === 'combo_hpv23_thinprep') prefix = 'GTHD-CB23TP';
